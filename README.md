...
Exemple pour publier la version `0.1.29` :

```bash
cd /home/Doonix/DooSys_GitHub/glpi-brandpulse
git status
git add .
git commit -m "Prepare GLPI BrandPulse 0.1.29"
git push origin main
git tag -a v0.1.29 -m "GLPI BrandPulse v0.1.29"
...
rm -rf brandpulse
curl -L -o /tmp/glpi-brandpulse.zip https://github.com/DooSys/glpi-brandpulse/releases/download/v0.1.29/glpi-brandpulse-0.1.29.zip
