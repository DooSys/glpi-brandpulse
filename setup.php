...
const PLUGIN_BRANDPULSE_VERSION = '0.1.1';
...
function plugin_init_brandpulse(): void
{
    ...
    if (class_exists(Plugin::class) && Plugin::isPluginActive('brandpulse')) {
        $PLUGIN_HOOKS[Hooks::ADD_CSS]['brandpulse'][] = 'public/css/brandpulse.css';
        $PLUGIN_HOOKS[Hooks::ADD_JAVASCRIPT]['brandpulse'][] = 'public/js/brandpulse.js';
    }
}
